...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "zzssxx" is the name you will use in your source code to
                // import this module (e.g. `@import("zzssxx")`). The name is
    ...
    const dma_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/dma_test.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "zzssxx", .module = mod },
